...
let decimal = 42;
console.log("Decimal:", decimal, "---",typeof decimal); // 42

// Binary (Base 2) - starts with 0b or 0B
let binary = 0b1010; // 10 in decimal
console.log("Binary 0b1010:", binary, "---",typeof binary); // 10

// Octal (Base 8) - starts with 0o or 0O
let octal = 0o52; // 42 in decimal
console.log("Octal 0o52:", octal, "---",typeof octal); // 42

// Hexadecimal (Base 16) - starts with 0x or 0X
let hex = 0x2A; // 42 in decimal
console.log("Hexadecimal 0x2A:", hex, "---",typeof hex); // 42
...
console.log("Float 3.14:", float1,"---",typeof float1);
console.log("Float -0.5:", float2, "---",typeof float2);
console.log("Float .5:", float3, "---",typeof float3);
console.log("Float 5.:", float4, "---",typeof float4);
...
console.log("Exponential 1.5e3:", exp1, "---",typeof exp1);   // 1500
console.log("Exponential 1.5e-3:", exp2, "---",typeof exp2);  // 0.0015
console.log("Exponential 2E10:", exp3, "---",typeof exp3);    // 20000000000
...
console.log("Separator 1_000_000:", million,"---",typeof million);      // 1000000
console.log("Separator 0b1010_0001:", binarySep, "---",typeof binarySep);  // 161
console.log("Separator 0xFF_FF:", hexSep, "---",typeof hexSep);         // 65535
...
console.log("BigInt literal:", big, "---",typeof big);
console.log("BigInt from string:", big2, "---",typeof big2);
console.log("BigInt from number:", bigFromNum, "---",typeof bigFromNum);
console.log("typeof BigInt:", typeof big); // "bigint"

// BigInt operations
console.log("BigInt + 1n:", big + 1n, "---",typeof(big + 1n));
